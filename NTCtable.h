...
template<size_t t>
constexpr size_t R2904 =
   (t % 5) ?
        R2904<(t ? t-1 : t)> * (1000 - NTC::resist_k2904[t/5*2+1]) / 1000
      : NTC::resist_k2904[t/5*2];

static_assert (R2904<0> == 35563);
static_assert (R2904<1> == 33607);
static_assert (R2904<2> == 31758);
static_assert (R2904<3> == 30011);
static_assert (R2904<4> == 28360);
static_assert (R2904<5> == 27119);

template<size_t ... i>
struct R2904_table {
   static constexpr uint16_t table[] = {R2904<i> ...};
};
