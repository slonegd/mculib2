...
constexpr typename template_TIM<adr, Pointer>::Channel template_TIM<adr,Pointer>::channel()
{
   if        constexpr (std::is_same_v<template_TIM,TIM1>) {
      ...
      else if constexpr (std::is_same_v<PIN,PE9>)  return Channel::_1;
      else if constexpr (std::is_same_v<PIN,PA9>)  return Channel::_2;
      else if constexpr (std::is_same_v<PIN,PE11>) return Channel::_2;
      else if constexpr (std::is_same_v<PIN,PA10>) return Channel::_3;
      else if constexpr (std::is_same_v<PIN,PE13>) return Channel::_3;
      else if constexpr (std::is_same_v<PIN,PA11>) return Channel::_4;
      else if constexpr (std::is_same_v<PIN,PE14>) return Channel::_4;

   } else if constexpr (std::is_same_v<template_TIM,TIM2>) {

      if      constexpr (std::is_same_v<PIN,PA15>) return Channel::_1;
      else if constexpr (std::is_same_v<PIN,PA1>)  return Channel::_2;
      else if constexpr (std::is_same_v<PIN,PB3>)  return Channel::_2;
      else if constexpr (std::is_same_v<PIN,PA2>)  return Channel::_3;
      else if constexpr (std::is_same_v<PIN,PB10>) return Channel::_3;
      else if constexpr (std::is_same_v<PIN,PA3>)  return Channel::_4;
      else if constexpr (std::is_same_v<PIN,PB11>) return Channel::_4;
   ...
   } else if constexpr (std::is_same_v<template_TIM,TIM4>) {

      if      constexpr (std::is_same_v<PIN,PB6>)  return Channel::_1;
      else if constexpr (std::is_same_v<PIN,PD12>) return Channel::_1;
      else if constexpr (std::is_same_v<PIN,PB7>)  return Channel::_2;
      else if constexpr (std::is_same_v<PIN,PD13>) return Channel::_2;
      else if constexpr (std::is_same_v<PIN,PB8>)  return Channel::_3;
      else if constexpr (std::is_same_v<PIN,PD14>) return Channel::_3;
      else if constexpr (std::is_same_v<PIN,PB9>)  return Channel::_4;
      else if constexpr (std::is_same_v<PIN,PD15>) return Channel::_4;

   } else if constexpr (std::is_same_v<template_TIM,TIM5>) {

      if      constexpr (std::is_same_v<PIN,PA0>)  return Channel::_1;
      else if constexpr (std::is_same_v<PIN,PH10>) return Channel::_1;
      else if constexpr (std::is_same_v<PIN,PA1>)  return Channel::_2;
      else if constexpr (std::is_same_v<PIN,PH11>) return Channel::_2;
      else if constexpr (std::is_same_v<PIN,PA2>)  return Channel::_3;
      else if constexpr (std::is_same_v<PIN,PH12>) return Channel::_3;
      else if constexpr (std::is_same_v<PIN,PA3>)  return Channel::_4;
      else if constexpr (std::is_same_v<PIN,PI0>)  return Channel::_4;

   } else if constexpr (std::is_same_v<template_TIM,TIM8>) {

      if      constexpr (std::is_same_v<PIN,PC6>)  return Channel::_1;
      else if constexpr (std::is_same_v<PIN,PI5>)  return Channel::_1;
      else if constexpr (std::is_same_v<PIN,PC7>)  return Channel::_2;
      else if constexpr (std::is_same_v<PIN,PI6>)  return Channel::_2;
      else if constexpr (std::is_same_v<PIN,PC8>)  return Channel::_3;
      else if constexpr (std::is_same_v<PIN,PI7>)  return Channel::_3;
      else if constexpr (std::is_same_v<PIN,PC9>)  return Channel::_4;
      else if constexpr (std::is_same_v<PIN,PI2>)  return Channel::_4;

   } else if constexpr (std::is_same_v<template_TIM,TIM9>) {

      if      constexpr (std::is_same_v<PIN,PA2>)  return Channel::_1;
      else if constexpr (std::is_same_v<PIN,PE5>)  return Channel::_1;
      else if constexpr (std::is_same_v<PIN,PA3>)  return Channel::_2;
      else if constexpr (std::is_same_v<PIN,PE6>)  return Channel::_2;

   } else if constexpr (std::is_same_v<template_TIM,TIM10>) {

      if      constexpr (std::is_same_v<PIN,PB8>)  return Channel::_1;
      else if constexpr (std::is_same_v<PIN,PF6>)  return Channel::_1;

   } else if constexpr (std::is_same_v<template_TIM,TIM11>) {

      if      constexpr (std::is_same_v<PIN,PB9>)  return Channel::_1;
      else if constexpr (std::is_same_v<PIN,PF7>)  return Channel::_1;
   }
...
{
   if      constexpr (std::is_same_v<template_TIM,TIM1>)  return GPIO_ral::AF::_1;
   else if constexpr (std::is_same_v<template_TIM,TIM2>)  return GPIO_ral::AF::_1;
   else if constexpr (std::is_same_v<template_TIM,TIM3>)  return GPIO_ral::AF::_2;
   else if constexpr (std::is_same_v<template_TIM,TIM4>)  return GPIO_ral::AF::_2;
   else if constexpr (std::is_same_v<template_TIM,TIM5>)  return GPIO_ral::AF::_2;
   else if constexpr (std::is_same_v<template_TIM,TIM8>)  return GPIO_ral::AF::_3;
   else if constexpr (std::is_same_v<template_TIM,TIM9>)  return GPIO_ral::AF::_3;
   else if constexpr (std::is_same_v<template_TIM,TIM10>) return GPIO_ral::AF::_3;
   else if constexpr (std::is_same_v<template_TIM,TIM11>) return GPIO_ral::AF::_3;
}
